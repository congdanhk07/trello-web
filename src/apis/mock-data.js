    ...
    columns: [
      {
        ...
        // Thứ tự sắp xếp / vị trí của các Card trong 1 Column
        cardOrderIds: [
          'card-id-02',
          'card-id-05',
          'card-id-03',
      ...
      },
      {
        ...
        /**
         * Thư viện DnD Kit không detect action column rỗng nên FE sẽ tự tạo
         * ra một Special Card -> Không liên quan đển Back-end -> "columnId-placeholder-card"
         * Mỗi Column chỉ có 1 card placeholder
         * Yêu cầu: _id, boardId, columnId, FE_PlaceholderCard
         *  **/
        cards: [
          {
